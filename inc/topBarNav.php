            ...
            <div class="container px-4 px-lg-5 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <?php if($_settings->userdata('id') != '' && $_settings->userdata('login_type') == 2): ?>
                      <div class="btn-group nav-link">
                        ...
                        <div class="dropdown-menu" role="menu">
                          ...
                          <div class="dropdown-divider"></div>
                          <a class="dropdown-item" href="<?php echo base_url.'?p=revenue' ?>"><span class="fa fa-table"></span> My Revenue</a>
                          <div class="dropdown-divider"></div>
                    ...
                    <?php else: ?>
                        ...
                        <a class="font-weight-bolder text-light mx-2 text-decoration-none" href="./manager">Manager Panel</a>
                    <?php endif;?>
                    </div>
                </div>
            </div>
