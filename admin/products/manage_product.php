				...
				<div class="container-fluid">
					<form action="" id="product-form">
						...
						<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
							...
							<input type="number" step="any" name="revenue" id="revenue" class="form-control form-control-sm rounded-0 text-right" value="<?php echo isset($revenue) ? $revenue : ''; ?>"  required/>
						</div>
						<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
