...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-light-maroon navbar-light elevation-4 sidebar-no-expand">
        <!-- Brand Logo -->
        <a href="<?php echo base_url ?>manager" class="brand-link bg-maroon text-sm">
              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>manager/?page=reports" class="nav-link nav-reports">
                    ...
                    <li class="nav-header">Maintenance</li>
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>manager/?page=user/list" class="nav-link nav-user_list">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>manager/?page=system_info/contact_info" class="nav-link nav-system_info_contact_info">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>manager/?page=system_info" class="nav-link nav-system_info">
